...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _shimmerAnimation =
        Tween<double>(begin: -1.5, end: 1.5).animate(
    ...
    _particleAnimation = Tween<double>(begin: 0, end: 2 * 3.14159).animate(
    ...
    try {
      ...
      if (mounted) {
        ...
        _showPopup(
          errorMessage!,
          isError: true,
          retryCallback: _testConnectionAndFetch,
        );
      }
  ...
  Future<void> _fetchStudents() async {
    try {
      ...
      if (mounted) {
        ...
        _showPopup(errorMessage!, isError: true, retryCallback: _fetchStudents);
      }
  ...
  void _showNotification(String message, {bool isError = false}) {
    ...
    _showPopup(message, isError: isError);
    ...
    showDialog(
      ...
      builder: (context) => FadeTransition(
        ...
        child: ScaleTransition(
          scale: Tween<double>(begin: 0.8, end: 1.0).animate(_popupAnimation),
          child: AlertDialog(
  ...
  Future<bool?> _showDeleteConfirmation(String name) async {
    return showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Apakah Anda yakin ingin menghapus "$name"? Tindakan ini tidak bisa dibatalkan.',
        ),
        actions: [
          TextButton(
                  ...
                  child: isLoading
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Dismissible(
                              key: Key(
                                student['nisn']?.toString() ?? 'default_$index',
                              ),
                              ...
                              onDismissed: (direction) => _deleteStudent(
                                ...
                                child: Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    subtitle: Column(
                                      ...
                                      children: [
                                        Text(
                                          'NISN: ${student['nisn'] ?? 'Tidak Diketahui'}',
                                          style: TextStyle(
                                            fontSize: 14,
                                            color: Colors.grey[600],
                                          ),
                                        ...
                                        Text(
                                          'Desa: ${student['desa'] ?? 'Tidak Diketahui'}',
                                          style: TextStyle(
                                            fontSize: 14,
                                            color: Colors.grey[600],
                                          ),
            ...
            Positioned(
              ...
              child: FadeTransition(
                ...
                child: Card(
                  ...
                  color: notificationMessage!.contains('Gagal')
                      ? Colors.red[700]
                      : Colors.green[700],
                  child: ListTile(
                    title: Text(
...
class ParticlePainter extends CustomPainter {
  ...
  ParticlePainter(this.animation, this.primaryDarkBlue)
